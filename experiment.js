...
timeline.push({
  ...
  stimulus: `
    ...
    <div style="text-align: left; max-height: 500px; overflow-y: auto; padding: 10px; border: 1px solid #ccc; font-size: 14px;">
      ...
      本調査への回答は、パソコン(Windows、Mac等)から行ってください。<strong>本調査には20分程度の回答時間を要します。静穏な環境で、全画面表示のままご回答ください。</strong></p>

      <h3>重要なお願い（必ずお読みください）</h3>
      <ul>
        <li><strong>本調査は全画面表示で行います。「同意する」を押すと自動的に全画面に切り替わります。全画面のまま最後までご回答ください。</li>
